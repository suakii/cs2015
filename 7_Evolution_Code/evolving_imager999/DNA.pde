...
DNA(int num) {
  ...
  void display(){
    ...
    canvas.stroke(genes[4], genes[5], genes[6], genes[7]);
    canvas.strokeWeight(2);
    
    canvas.line(genes[0],genes[1],genes[2],genes[3]);
  }
  
  void c_display(){
    //draw polygon on cache canvas on parameters
    c_canvas.stroke(genes[4], genes[5], genes[6], genes[7]);
    c_canvas.strokeWeight(2);
    
    c_canvas.line(genes[0],genes[1],genes[2],genes[3]);
  }
